...
test.describe('Delete Settlement', () => {
    test('Delete Settlement @smoke', async ({ page }) => {
        ...
        await settlementSection.deleteSettlement();
        await settlementSection.deleteConfirm();
        await settlementSection.deleteSuccessMsg(); 
    })
})
