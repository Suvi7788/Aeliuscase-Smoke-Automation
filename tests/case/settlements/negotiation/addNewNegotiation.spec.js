...
test.describe('Add New Negotiation', () => {
    ...
    test('Add New Negotiation @smoke', async ({ page }) => {
        ...
        await negotiationSection.selectType();
        await negotiationSection.addAmount();
        await negotiationSection.saveNegotiation();
        await negotiationSection.verifySaveSuccessMsg();
    })
})
