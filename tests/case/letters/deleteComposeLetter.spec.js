...
test.describe('DownloadComposedLetter', () => {
    test('DownloadComposedLetter @smoke', async ({ page }) => {
        ...
        await lettersSection.deleteComposeLetter();
        await lettersSection.deleteConferm();
