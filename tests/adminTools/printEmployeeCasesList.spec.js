...
test('Print Employee Cases List', async ({ page }) => {
    ...
    await employeeCasesPage.clickAwayFromAdminTools();
    await employeeCasesPage.printEmployeeCasesList();
    await employeeCasesPage.verifyPrintEmployeeCasesList();
});
